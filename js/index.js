    ...
    function principale () {
        ...
        if (depart) {
            if(fin) {
                ...
                lettrePleine ('FIN DU JEU !', 250, 150, 80, police, 'orange');
                lettrePleine ('Bonne réponse : ' + bonneReponse, 250, 230, 40, police, 'green');
                lettrePleine ('Mauvaise réponse : ' + mauvaiseReponse, 250, 280, 40, police, 'red');
                icone();
                ...
                lettrePleine ('Réponse : Bonne | Mauvaise', 720, 40, 16, police, 'DarkBlue');
